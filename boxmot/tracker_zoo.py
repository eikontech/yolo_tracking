...
from event_manager.yolo_tracking.boxmot.strongsort.utils.parser import get_config
...
def create_tracker(tracker_type, tracker_config, reid_weights, device, half):
    ...
    if tracker_type == 'strongsort':
        ...
        from event_manager.yolo_tracking.boxmot.ocsort.ocsort import OCSort
        ocsort = OCSort(
        ...
        from event_manager.yolo_tracking.boxmot.deepocsort.ocsort import OCSort
        deepocsort = OCSort(
            reid_weights,
            device,
            half,
